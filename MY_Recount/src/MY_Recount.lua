	...
	tDefaultCss = {
		{
			['Bar'] = {
				...
				[FORCE_TYPE.SHAO_LIN ] = { r = 255, g = 178, b = 95 , a = 144 }, -- 少林
				[FORCE_TYPE.WAN_HUA  ] = { r = 196, g = 152, b = 255, a = 180 }, -- 万花
				[FORCE_TYPE.TIAN_CE  ] = { r = 255, g = 111, b = 83 , a = 200 }, -- 天策
				[FORCE_TYPE.CHUN_YANG] = { r = 89 , g = 224, b = 232, a = 144 }, -- 纯阳 56,175,255,232
				[FORCE_TYPE.QI_XIU   ] = { r = 255, g = 129, b = 176, a = 128 }, -- 七秀
				[FORCE_TYPE.WU_DU    ] = { r = 55 , g = 147, b = 255, a = 128 }, -- 五毒
				[FORCE_TYPE.TANG_MEN ] = { r = 121, g = 183, b = 54 , a = 180 }, -- 唐门
				[FORCE_TYPE.CANG_JIAN] = { r = 214, g = 249, b = 93 , a = 144 }, -- 藏剑
				[FORCE_TYPE.GAI_BANG ] = { r = 205, g = 133, b = 63 , a = 180 }, -- 丐帮
				[FORCE_TYPE.MING_JIAO] = { r = 240, g = 70 , b = 96 , a = 144 }, -- 明教
