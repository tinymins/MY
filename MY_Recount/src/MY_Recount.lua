	...
	tDefaultCss = {
		{
			['Bar'] = {
				...
				[FORCE_TYPE.WAN_HUA  ] = { r = 62 , g = 22 , b = 155, a = 144 }, -- 万花
				[FORCE_TYPE.TIAN_CE  ] = { r = 160, g = 0  , b = 0  , a = 180 }, -- 天策
				[FORCE_TYPE.CHUN_YANG] = { r = 0  , g = 146, b = 235, a = 180 }, -- 纯阳
				[FORCE_TYPE.QI_XIU   ] = { r = 239, g = 61 , b = 171, a = 144 }, -- 七秀
				[FORCE_TYPE.WU_DU    ] = { r = 132, g = 23 , b = 152, a = 144 }, -- 五毒
				[FORCE_TYPE.TANG_MEN ] = { r = 0  , g = 46 , b = 188, a = 180 }, -- 唐门
				[FORCE_TYPE.CANG_JIAN] = { r = 255, g = 255, b = 0  , a = 144 }, -- 藏剑
				[FORCE_TYPE.GAI_BANG ] = { r = 205, g = 133, b = 63 , a = 180 }, -- 丐帮
				[FORCE_TYPE.MING_JIAO] = { r = 253, g = 84 , b = 0  , a = 180 }, -- 明教
