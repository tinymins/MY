...
local _BUILD_                 = '20210630'
local _NATURAL_VERSION_       = 207
local _VERSION_               = '5.0.0'
...
local function IsHugeNumber(var) return IsNumber(var) and not (var < HUGE) and not (var > -HUGE) end
