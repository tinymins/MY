...
local _BUILD_                 = '20221024'
local _VERSION_               = '14.1.1'
...
local _LOG_LEVEL_             = math.min(DEBUG_LEVEL[LoadLUAData(_DATA_ROOT_ .. 'log.level.jx3dat') or 'NONE'] or DEBUG_LEVEL.NONE, _DEBUG_LEVEL_)
