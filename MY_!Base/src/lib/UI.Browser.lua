...
function D.Open(url, options)
	...
	if X.UI.IS_GLASSMORPHISM then
		frame:Lookup('', 'Image_BgTL_Conner'):Hide()
		frame:Lookup('', 'Image_BgTL_Flex'):Hide()
		frame:Lookup('', 'Image_BgTL_Center'):Hide()
		frame:Lookup('', 'Image_BgTR_Center'):Hide()
		frame:Lookup('', 'Image_BgTR_Flex'):Hide()
		frame:Lookup('', 'Image_BgTR_Conner'):Hide()
		frame:Lookup('', 'Image_BgCL'):Hide()
		frame:Lookup('', 'Image_BgCC'):Hide()
		frame:Lookup('', 'Image_BgCR'):Hide()
		frame:Lookup('', 'Image_BgBR'):Hide()
		frame:Lookup('', 'Image_BgBC'):Hide()
		frame:Lookup('', 'Image_BgBL'):Hide()
		frame:Lookup('', 'Image_TitleBg'):Hide()
		frame:Lookup('', 'Image_Logo'):SetRelY(7)
		frame:Lookup('', 'Text_Title'):SetRelY(2)
		frame:Lookup('WndContainer_TitleBtnR'):SetRelY(7)
	else
		frame:Lookup('', 'Image_Glassmorphism'):Hide()
		frame:Lookup('', 'Image_Glassmorphism_Bg'):Hide()
		frame:Lookup('', 'Image_Glassmorphism_Title_Bg'):Hide()
		frame:Lookup('', 'Image_Glassmorphism_Title_TextureL'):Hide()
		frame:Lookup('', 'Image_Glassmorphism_Title_TextureR'):Hide()
	end
