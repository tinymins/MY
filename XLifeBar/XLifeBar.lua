...
_Cache.OnPanelActive = function(wnd)
    ...
    ui:append("WndCheckBox_GlobalConfig", "WndCheckBox"):children("#WndCheckBox_GlobalConfig")
      ...
      :check(function(bChecked)
        ...
        ui:children("#WndSliderBox_FristHeight"):value(Config.nFirstHeight)
        ui:children("#WndSliderBox_SecondHeight"):value(Config.nSecondHeight)
        ui:children("#WndSliderBox_ThirdHeight"):value(Config.nThirdHeight)
