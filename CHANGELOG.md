...
* [常用工具] 由于性能问题门派能量条不再区分藏剑双心法
* [目标监控] 由于性能问题气劲监控不再区分藏剑双心法
* [团队面板] 由于性能问题团队面板目标监控不再区分藏剑双心法

## 茗伊插件集 v15.6.2

* [团队监控] 修复团队面板气劲监控数据显示问题
...
* [角色统计] 移除新版本无法使用的宠物统计模块
* [角色统计] 接入枫影插件集实现的奇遇统计模块

## 茗伊插件集 v15.5.2

* [团队监控] 修复气血内力时间轴解析失败的问题

## 茗伊插件集 v15.5.1

* [团队监控] 临时屏蔽自定义语音包功能用户端露出

## 茗伊插件集 v15.5.0

* [团队监控] 语音包下载界面增加预览试听入口按钮
...
* [角色统计] 修复奇遇完成状态显示异常的问题
* [团队监控] 修复自身气劲列表大小设置不实时生效的问题
...
* [基础库] 更新日常任务数据
* [团队监控] 修复气血内力变化倒计时不能触发的问题
* [团队监控] 修复进入战斗倒计时条离开战斗时不能自动清除的问题

## 茗伊插件集 v14.0.0

* [基础库] 标准化获取格式化时间相关接口逻辑
* [团队监控] 修复气海内力倒计时编辑框错误提示逻辑问题
* [团队面板] 修复获取团队监控“团队面板条件监控”优先级次序反转的问题
* [角色统计] 修复角色统计不能重置冷却的逻辑问题
* [目标监控] 按官方要求目标监控降低刷新频率为每两帧一次
...
* [角色统计] 修复宠物宾宾对话计数器不更新的问题
* [常用工具] 修复动态物品栏初始化问题
* [常用工具] 修复角色高亮退出时可能抛出异常的问题
* [团队监控] 修复团队监控标记目标在某些特殊情况下不生效的问题
...
* [头顶血条] 因性能考虑插件不再绘制头顶，官方统一接管头顶血条渲染
* [战斗统计] 修复获取玩家装备可能次数过多的问题
* [游戏字体] 增加角色头顶字体设置
* [目标监控] 修复倒计时条时间小数点不显示的问题
...
* [基础库] 弹出菜单增加打开关闭效果音
* [团队监控] 修复可以标记禁止焦点 NPC 的问题
* [团队监控] 倒计时设置按住 CTRL 可显示唯一标识符方便编辑
* [头顶血条] 修复出现错误的调试输出的问题
* [目标监控] 使用团队监控倒计时条风格优化显示效果
