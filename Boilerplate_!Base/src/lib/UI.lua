...
local _tItemXML = {
	...
	['CheckBox'] = '<handle>name="CheckBox" w=100 h=28 <image>name="Image_Default" w=28 h=28 path="ui\\Image\\button\\CommonButton_1.UITex" frame=5 </image><text>name="Text_Default" font=162 valign=1 showall=0 x=29 w=71 h=28 </text></handle>',
	['ColorBox'] = '<handle>name="ColorBox" w=100 h=28 eventid=277 <shadow>name="Shadow_Default" w=28 h=28 </shadow><text>name="Text_Default" font=162 valign=1 showall=0 x=29 w=71 h=28 </text></handle>',
}
...
function OO:ListBox(method, arg1, arg2, arg3, arg4)
	...
	if method == 'option' and (IsNil(arg1) or (IsString(arg1) and IsNil(arg2))) then -- get
		...
		elseif method == 'select' then
			...
			return tData
		elseif method == 'insert' then
			local text, id, data, pos, r, g, b = arg1, arg2, arg3, nil, nil, nil, nil
