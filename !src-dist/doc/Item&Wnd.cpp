...
//		{ "__newindex",						LuaItemNull_NewIndex },
	...
	static luaL_reg const s_aItemImageMetaTable[] =
	{
		...
		{ "ToGray",					        LuaItemImage_ToGray },
		{ "ToNormal",					    LuaItemImage_ToNormal },
		{ "IsGray",					        LuaItemImage_IsGray },
	...
	KScriptLoader::RegisterMetaTable(L, g_GetWndItemName(ITEM_TEXT), s_aItemNullMetaTable, s_aItemTextMetaTable);
	KScriptLoader::RegisterMetaTable(L, g_GetWndItemName(ITEM_IMAGE), s_aItemNullMetaTable, s_aItemImageMetaTable);
	KScriptLoader::RegisterMetaTable(L, g_GetWndItemName(ITEM_ANIAMTE), s_aItemNullMetaTable, s_aItemAnimateMetaTable);
	KScriptLoader::RegisterMetaTable(L, g_GetWndItemName(ITEM_SHADOW), s_aItemNullMetaTable, s_aItemShadowMetaTable);
	KScriptLoader::RegisterMetaTable(L, g_GetWndItemName(ITEM_SCENE), s_aItemNullMetaTable, s_aItemSceneMetaTable);
	KScriptLoader::RegisterMetaTable(L, g_GetWndItemName(ITEM_BOX), s_aItemNullMetaTable, s_aItemBoxMetaTable);
	KScriptLoader::RegisterMetaTable(L, g_GetWndItemName(ITEM_HANDLE), s_aItemNullMetaTable, s_aItemHandleMetaTable);
	KScriptLoader::RegisterMetaTable(L, g_GetWndItemName(ITEM_TREE_LEAFE), s_aItemNullMetaTable, s_aItemTreeLeafMetaTable);
	KScriptLoader::RegisterMetaTable(L, g_GetWndItemName(ITEM_SFX), s_aItemNullMetaTable, s_aItemSFXMetaTable);
}
...
//			{ "__newindex",							LuaWindow_NewIndex },
	...
	{
		{ "SetScrollVerStepSzie",			    LuaScroll_SetScrollVerStepSzie },
		{ "SetScrollHorStepSzie",			    LuaScroll_SetScrollHorStepSzie },
		{ NULL,									NULL },
	};
	...
	KScriptLoader::RegisterMetaTable(L, "WndEdit",			s_aWndWindowMetaTable, s_aWndEditMetaTable);
	KScriptLoader::RegisterMetaTable(L, "WndButton",		s_aWndWindowMetaTable, s_aWndButtonMetaTable);
	KScriptLoader::RegisterMetaTable(L, "WndCheckBox",		s_aWndWindowMetaTable, s_aWndCheckBoxMetaTable);
	KScriptLoader::RegisterMetaTable(L, "WndNewScrollBar",	s_aWndWindowMetaTable, s_aWndNewScrollBarMetaTable);
	KScriptLoader::RegisterMetaTable(L, "WndScroll",		s_aWndWindowMetaTable, s_aWndScrollMetaTable);
	KScriptLoader::RegisterMetaTable(L, "WndScene",			s_aWndWindowMetaTable, s_aWndSceneMetaTable);
	KScriptLoader::RegisterMetaTable(L, "WndMovie",			s_aWndWindowMetaTable, s_aWndMovieMetaTable);
	KScriptLoader::RegisterMetaTable(L, "WndTexture",		s_aWndWindowMetaTable, s_aWndTextureMetaTable);
	KScriptLoader::RegisterMetaTable(L, "WndPageSet",		s_aWndWindowMetaTable, s_aWndPageSetMetaTable);
	KScriptLoader::RegisterMetaTable(L, "WndPage",			s_aWndWindowMetaTable, s_aWndWindowMetaTable);
	KScriptLoader::RegisterMetaTable(L, "WndFrame",			s_aWndWindowMetaTable, s_aWndFrameMetaTable);
	KScriptLoader::RegisterMetaTable(L, "WndMinimap",		s_aWndWindowMetaTable, s_aWndMinimapMetaTable);
	KScriptLoader::RegisterMetaTable(L, "WndWebPage",		s_aWndWindowMetaTable, s_aWndWebPageMetaTable);
